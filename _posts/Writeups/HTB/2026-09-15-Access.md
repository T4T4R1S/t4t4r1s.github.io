...
description: Walkthrough of the Access machine – anonymous FTP leading to a chain of leaked credentials across a database, a password-protected zip, and an Outlook mailbox, followed by a telnet foothold and privesc via cached Administrator credentials.
...
[Access](https://app.hackthebox.com/machines/Access?sort_by=created_at&sort_type=desc) is an Easy WWalkthrough of the Access machine – anonymous FTP leading to a chain of leaked credentials across a database, a password-protected zip, and an Outlook mailbox, followed by a telnet foothold and privesc via cached Administrator credentials.
